...
The official GVSU record and the license URL embedded in the source point to
[CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/). The source
preface also contains conflicting prose naming version 4.0; this edition therefore
...
new hints, solutions or proof guidance, mastery questions, error diagnostics, and
stable-ID metadata. No endorsement by Schlicker, GVSU, or the upstream repository
is claimed.

CC BY 4.0 applies only to the new companion expression. It does not alter the
CC BY-NC-SA 3.0 conditions on the translated GVSU spine, and it does not relicense
separately noticed software, XSLT, fonts, or image assets. Those components retain
their own notices and must remain separately represented in every distribution
manifest.
