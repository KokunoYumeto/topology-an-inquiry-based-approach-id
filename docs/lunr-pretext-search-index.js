...
},
{
  ...
  "type": "Pemeriksaan",
  "number": "E.48",
  "title": "Tugas 37: jarak nol dan tutupan.",
  "body": "Tugas 37: jarak nol dan tutupan  Putuskan benar atau salah: jika tak kosong dan , maka . Rubrik: jika salah, berikan contoh konkret dalam metrik Euklides dan nyatakan hubungan yang tepat antara jarak nol, tutupan , dan keanggotaan dalam .    Langkah 1. Ambil dan . Titik-titik berada dalam untuk dan mendekati .   Langkah 2. Dalam ruang metrik, mencirikan , bukan selalu .   Salah. Untuk dan , berlaku , tetapi . Yang benar ialah jika dan hanya jika ; keanggotaan dalam tutupan tidak sama dengan keanggotaan dalam kecuali, misalnya, tertutup.   Gunakan metrik Euklides pada . Ambil dan . Semua jarak dengan positif, tetapi untuk setiap terdapat dengan . Oleh karena itu . Meskipun demikian, . Ini membantah pernyataan.  Secara umum dalam ruang metrik, berarti bahwa untuk setiap terdapat dengan ; pernyataan ini setara dengan setiap bola terbuka di sekitar bertemu , yakni . Sebaliknya, sifat tutupan tersebut membuat infimum semua jarak ke sama dengan nol. Jadi kesetaraan yang tepat adalah . Dari sini hanya dapat disimpulkan apabila diketahui tambahan bahwa , misalnya bila tertutup.  "
},
{
...
},
{
  ...
  "type": "Pemeriksaan",
  "number": "E.50",
  "title": "Jarak nol dan tutupan.",
  "body": "Jarak nol dan tutupan  Misalkan ruang metrik, tak kosong, dan . Buktikan bahwa    Rubrik. Buktikan kedua implikasi dengan definisi tutupan melalui bola terbuka; nyatakan secara eksplisit bagaimana sifat infimum menghasilkan titik pada jarak kurang dari .    Langkah 1. Jika , maka untuk setiap .   Langkah 2. Jika infimum himpunan jarak adalah nol tetapi tidak ada jarak yang lebih kecil daripada suatu , maka akan menjadi batas bawah positif.   Kesetaraan itu benar: tepat ketika setiap bola terbuka berpusat di bertemu , dan kondisi terakhir adalah definisi .   Andaikan . Untuk setiap , ada dengan . Karena infimum tidak melebihi setiap anggota himpunan yang diinfimumkan, . Tidak ada bilangan real positif yang lebih kecil daripada setiap ; maka .  Sebaliknya, andaikan . Ambil sembarang . Jika semua memenuhi , maka merupakan batas bawah himpunan , bertentangan dengan fakta bahwa batas bawah terbesarnya adalah nol. Jadi terdapat dengan . Artinya untuk setiap radius positif, sehingga .  "
},
{
...
},
{
  ...
  "body": "Setiap fungsi dari ruang diskret kontinu  Pada perintah kedua latihan penutup, domain bermetrik diskret dan adalah ruang metrik sebarang. Buktikan bahwa setiap fungsi kontinu. Rubrik. Terapkan karakterisasi kekontinuan melalui prapeta himpunan terbuka dan gunakan hasil perintah sebelumnya.    Langkah 1. Ambil himpunan terbuka sebarang dan amati bahwa hanyalah suatu subhimpunan dari .   Langkah 2. Semua subhimpunan dari ruang diskret terbuka; masukkan fakta ini ke kriteria prapeta-terbuka.   Ya. Untuk setiap himpunan terbuka , prapetanya merupakan subhimpunan ruang diskret , maka terbuka. Jadi kontinu.   Misalkan suatu himpunan terbuka dalam . Apa pun nilai-nilai fungsi , himpunan adalah suatu subhimpunan dari . Menurut hasil perintah pertama, setiap subhimpunan dari terbuka karena memakai metrik diskret. Jadi terbuka dalam untuk setiap himpunan terbuka . Karakterisasi kekontinuan melalui prapeta himpunan terbuka sekarang memberi bahwa kontinu.  "
},
{
...
},
{
  ...
  "type": "Pemeriksaan",
  "number": "H.42",
  "title": "Kriteria kekontinuan melalui interior prapeta.",
  "body": "Kriteria kekontinuan melalui interior prapeta  Pada perintah kedua belas latihan penutup, untuk fungsi , buktikan bahwa kontinu jika dan hanya jika untuk setiap . Rubrik. Pada arah maju gunakan bahwa terbuka; pada arah balik substitusikan himpunan terbuka sebagai dan buktikan prapetanya terbuka.    Langkah 1. Jika kontinu, maka adalah himpunan terbuka yang termuat dalam .   Langkah 2. Jika inklusi diasumsikan dan terbuka, gunakan serta .   Pernyataan bikondisional itu benar. Arah maju mengikuti sifat interior sebagai himpunan terbuka terbesar; arah balik membuat setiap prapeta himpunan terbuka sama dengan interiornya sendiri.   Andaikan kontinu dan ambil sebarang . Himpunan terbuka dalam , sehingga terbuka dalam . Karena , berlaku . Setiap himpunan terbuka yang termuat dalam termuat dalam interiornya. Maka   Sebaliknya, andaikan inklusi tersebut berlaku untuk setiap . Ambil himpunan terbuka sebarang dan pilih . Karena , hipotesis memberi . Inklusi sebaliknya selalu berlaku dari definisi interior, jadi . Dengan hasil perintah keempat, terbuka. Prapeta setiap himpunan terbuka terbuka, maka kontinu.  "
},
{
...
},
{
  ...
  "body": "Konvers subruang dan limit ambien di luar subruang  Pada perintah kesepuluh latihan penutup, jelaskan mengapa konvers harfiah perintah sebelumnya benar ketika semua hipotesisnya, termasuk , dipertahankan. Kemudian, untuk barisan rasional yang konvergen ke dalam , buktikan sifat Cauchy yang diminta dan tentukan apakah barisan itu konvergen dalam subruang . Rubrik. Bedakan tegas dua klaim: konvers dengan limit di subruang memang benar, sedangkan contoh mempunyai limit ambien di luar subruang.    Langkah 1. Untuk konvers harfiah, gunakan lagi . Untuk sifat Cauchy, pilih sehingga jika .   Langkah 2. Jika barisan tersebut konvergen ke suatu dalam subruang, gunakan perintah sebelumnya dan ketunggalan limit di .   Konvers harfiahnya benar: jika limit ambien berada dalam , jarak subruang dan ambien sama. Barisan rasional yang menuju bersifat Cauchy, tetapi tidak konvergen dalam , sebab satu-satunya limit ambiennya adalah bilangan irasional .   Pertama, pertahankan semua hipotesis bagian sebelumnya dan andaikan dalam , dengan . Untuk setiap , akhirnya . Karena , pertidaksamaan yang sama membuktikan dalam . Jadi konvers harfiah itu benar.  Sekarang misalkan dan dalam . Diberikan , pilih sehingga untuk setiap . Jika , pertidaksamaan segitiga memberi Jadi barisan itu Cauchy.  Andaikan barisan tersebut konvergen dalam ke suatu . Perintah sebelumnya akan membuatnya konvergen dalam ke . Namun di barisan yang sama sudah konvergen ke , dan limit dalam ruang metrik tunggal. Maka harus berlaku , bertentangan dengan . Jadi barisan itu tidak konvergen dalam . Contoh ini tidak membantah konvers harfiah, karena limit ambiennya tidak berada dalam subruang.  "
},
{
...
},
{
  ...
  "body": "Limit jumlah dua barisan  Pada perintah ke-12 latihan penutup, jika dan , buktikan bahwa . Rubrik. Bagi toleransi menjadi dua bagian dan gunakan pertidaksamaan segitiga.    Langkah 1. Cari indeks setelah mana dan indeks setelah mana .   Langkah 2. Ambil maksimum kedua indeks dan taksir .   Benar. Setelah kedua selisih masing-masing kurang dari , pertidaksamaan segitiga membuat selisih jumlah kurang dari .   Tetapkan . Pilih sehingga untuk , dan pilih sehingga untuk . Tetapkan . Untuk , Maka .  "
},
{
...
},
{
  ...
  "body": "Hukum limit untuk hasil bagi  Untuk perintah tentang , buktikan hukum limit hasil bagi ketika , , dan setiap . Rubrik: terlebih dahulu batasi penyebut menjauhi nol, lalu pisahkan selisih hasil bagi menjadi dua suku.   Tahap 1: akhirnya , sehingga . Tahap 2: tambahkan dan kurangkan sebelum memakai pertidaksamaan segitiga.   Barisan hasil bagi konvergen dan .   Karena , ada sehingga bagi ; akibatnya . Untuk indeks tersebut, Jika , suku kedua hilang. Jika tidak, pilih ambang bagi kedua barisan sehingga masing-masing suku di ruas kanan lebih kecil dari , lalu ambil maksimum bersama . Maka selisih hasil bagi lebih kecil dari untuk semua indeks sesudah ambang itu, yang membuktikan limit yang dinyatakan.  "
},
{
...
},
{
  ...
  "type": "Pemeriksaan",
  "number": "I.41",
  "title": "Membangun barisan dari irisan bola.",
  "body": "Membangun barisan dari irisan bola  Nilai pernyataan: jika setiap bola bertemu subhimpunan tak kosong , maka ada barisan di yang konvergen ke . Rubrik: pilih satu titik dari bola berjari-jari untuk setiap .   Pilih . Definisi bola langsung memberi batas atas untuk .   Pernyataan benar; pilihan menghasilkan barisan yang konvergen ke .   Hipotesis menjamin bahwa tidak kosong untuk setiap . Pilih dari irisan itu. Maka . Untuk , pilih . Jika , maka . Jadi barisan yang seluruh sukunya berada di tersebut konvergen ke .  "
},
{
