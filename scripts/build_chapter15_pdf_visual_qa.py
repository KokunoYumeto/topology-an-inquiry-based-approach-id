#!/usr/bin/env python3
"""Analyze the existing cumulative Chapter 15 PDF raster closure.

This is the Chapter 15 configuration of the maintained Chapter 11 pixel-QA
...
sheet inventory are separate inputs to the final Chapter 15 QA workflow.
...
# are bound by the Chapter 15 source-manifest gate after their own producers run.
BUILD_LOG_RUN1 = ROOT / "qa/CHAPTER15_PDF_BUILD_RUN1.log"
BUILD_LOG_RUN2 = ROOT / "qa/CHAPTER15_PDF_BUILD_RUN2.log"
HASH_RECEIPT_RUN1 = ROOT / "qa/CHAPTER15_PDF_RUN1_HASH.json"
HASH_RECEIPT_RUN2 = ROOT / "qa/CHAPTER15_PDF_RUN2_HASH.json"
STRUCTURE_RECEIPT = ROOT / "qa/CHAPTER15_PDF_STRUCTURE.json"
VISUAL_RECEIPT = ROOT / "qa/CHAPTER15_PDF_VISUAL_QA.json"
RUN1_PDF = ROOT / "tmp/pdfs/chapter15-run1.pdf"
RENDER_DIR = ROOT / "tmp/pdfs/chapter15-render"
CONTACT_SHEET_DIR = ROOT / "tmp/pdfs/chapter15-contact"
CONTACT_SHEET_PATTERN = "tmp/pdfs/chapter15-contact/contact-NN.png"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Exact Chapter 15 cumulative build log; required unless --check-only "
...
def configure_engine() -> None:
    """Bind the shared, read-only analysis engine to the Chapter 15 closure."""
    engine.__doc__ = __doc__
    engine.ROOT = ROOT
    engine.PDF = ROOT / "output/chapters01-15-pdf/chapters_01_15_reader.pdf"
    engine.RENDER_DIR = RENDER_DIR
    engine.OUTPUT = VISUAL_RECEIPT
    engine.PDF_RELATIVE = "output/chapters01-15-pdf/chapters_01_15_reader.pdf"
    engine.RENDER_PATTERN = "tmp/pdfs/chapter15-render/page-NNN.png"
    engine.BOUNDARY_LABEL = "Chapter 15"
