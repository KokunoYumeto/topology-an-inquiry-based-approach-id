#!/usr/bin/env python3
"""Analyze the existing cumulative Chapter 16 PDF raster closure.

This is the Chapter 16 configuration of the maintained Chapter 11 pixel-QA
...
sheet inventory are separate inputs to the final Chapter 16 QA workflow.
...
# are bound by the Chapter 16 source-manifest gate after their own producers run.
BUILD_LOG_RUN1 = ROOT / "qa/CHAPTER16_PDF_BUILD_RUN1.log"
BUILD_LOG_RUN2 = ROOT / "qa/CHAPTER16_PDF_BUILD_RUN2.log"
HASH_RECEIPT_RUN1 = ROOT / "qa/CHAPTER16_PDF_RUN1_HASH.json"
HASH_RECEIPT_RUN2 = ROOT / "qa/CHAPTER16_PDF_RUN2_HASH.json"
STRUCTURE_RECEIPT = ROOT / "qa/CHAPTER16_PDF_STRUCTURE.json"
VISUAL_RECEIPT = ROOT / "qa/CHAPTER16_PDF_VISUAL_QA.json"
RUN1_PDF = ROOT / "tmp/pdfs/chapter16-run1.pdf"
RENDER_DIR = ROOT / "tmp/pdfs/chapter16-render"
CONTACT_SHEET_DIR = ROOT / "tmp/pdfs/chapter16-contact"
CONTACT_SHEET_PATTERN = "tmp/pdfs/chapter16-contact/contact-NN.png"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Exact Chapter 16 cumulative build log; required unless --check-only "
...
def configure_engine() -> None:
    """Bind the shared, read-only analysis engine to the Chapter 16 closure."""
    engine.__doc__ = __doc__
    engine.ROOT = ROOT
    engine.PDF = ROOT / "output/chapters01-16-pdf/chapters_01_16_reader.pdf"
    engine.RENDER_DIR = RENDER_DIR
    engine.OUTPUT = VISUAL_RECEIPT
    engine.PDF_RELATIVE = "output/chapters01-16-pdf/chapters_01_16_reader.pdf"
    engine.RENDER_PATTERN = "tmp/pdfs/chapter16-render/page-NNN.png"
    engine.BOUNDARY_LABEL = "Chapter 16"
