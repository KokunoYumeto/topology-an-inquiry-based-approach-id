#!/usr/bin/env python3
"""Build the deterministic, sanitized Chapters 1–11 Zenodo preservation set."""
...
HTML_ROOT = ROOT / "output" / "chapters01-11-html"
SOURCE_MANIFEST = ROOT / "qa" / "CHAPTER11_SOURCE_MANIFEST.json"
HTML_MANIFEST = ROOT / "qa" / "CHAPTER11_HTML_MANIFEST.json"
...
REQUIRED_EVIDENCE_PATHS = {
    "repo/qa/CHAPTER11_BROWSER_QA.json",
    "repo/qa/CHAPTER11_PDF_RUN1_HASH.json",
    "repo/qa/CHAPTER11_PDF_RUN2_HASH.json",
    "repo/qa/CHAPTER11_PDF_STRUCTURE.json",
    "repo/qa/CHAPTER11_PDF_VISUAL_QA.json",
    "repo/qa/CHAPTER11_DOCS_MANIFEST.json",
    "repo/qa/CHAPTER11_DOCS_QA.json",
    "repo/qa/CHAPTER11_BUILD_QA.md",
    "repo/qa/CHAPTER10_GITHUB_PUBLICATION_RECEIPT.md",
    "repo/qa/CHAPTER10_ZENODO_PUBLICATION_RECEIPT.md",
    "repo/qa/CHAPTER10_FIGSHARE_PUBLICATION_RECEIPT.md",
}
...
def html_entries(
    ...
    for name, path in (
        ...
        ("CHAPTER11_HTML_MANIFEST.json", HTML_MANIFEST),
    ):
...
def source_entries(source_manifest: dict[str, object]) -> dict[str, bytes]:
    ...
    current_manifest_name = f"{prefix}/repo/qa/CHAPTER11_SOURCE_MANIFEST.json"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "output" / "zenodo-chapters01-11",
    )
    parser.add_argument(
        "--version",
        default="2026.08.23-bab01-11",
    ...
    parser.add_argument(
        ...
        type=int,
        default=22_063_094,
        help="published Chapters 1-10 Zenodo record in the existing concept lineage",
    )
    ...
    if (
        ...
        != "chapters_01_11_with_separately_licensed_self_study_companions"
    ):
    ...
    if expected_pdf.get("status") != "pass":
        raise RuntimeError("source manifest has not admitted the Chapter 11 PDF")
    ...
    package_manifest = {
        ...
        "record": {
            ...
            "language": "ind",
            "completion": {"chapters_verified": 11, "chapters_total": 20, "complete": False},
        },
        "authority": {
        ...
        "reader": {
            ...
            "source_manifest": {"path": "qa/CHAPTER11_SOURCE_MANIFEST.json", **identity(SOURCE_MANIFEST)},
        },
        "rights": [
            {
        ...
        "caveats": [
            "This is a verified 11-of-20 maintenance boundary, not the complete edition.",
