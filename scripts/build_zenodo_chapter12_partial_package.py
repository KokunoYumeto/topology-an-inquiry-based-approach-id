    ...
    manifest = {
        ...
        "record": {
            ...
            "source_checkpoint": {
                ...
                "companion_prompt_units_covered": 41,
                "companion_prompt_units_pending": 37,
                "companion_surfaces": 164,
        ...
        "source_checkpoint": {
            ...
            "github_content_commit": "3fee7441575e3921e00fed93006df040b12711ee",
            "github_receipt_commit": "c861686152953fcffe8b75878faf11bf88421cf4",
            "github_receipt_sha256": digest((ROOT / "qa" / "CHAPTER12_EXERCISE_A_GITHUB_RECEIPT.md").read_bytes()),
        },
        "reader": {
